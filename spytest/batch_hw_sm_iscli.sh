...
SM_ISCLI_REPORT_ROOT="./logs/HW_SM_ISCLI_Report"
BASE_LOG="${SM_ISCLI_REPORT_ROOT}/SM_ISCLI_${DATE_DIR}"

mkdir -p "${BASE_LOG}"

echo "=============================================="
echo "HW SM_ISCLI REGRESSION STARTED"
echo " DATE : ${DATE_DIR}"
echo "=============================================="
...
run_batch "SM_ISCLI_7_STATIC_ROUTES" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_4_EBGP_MULTIHOP" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_5_BGP_L2VPN_EVPN" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_6_BGP_TIMERS" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_59_MGMT_IP_ROUTE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_43_SM_ISCLI_61_MGMT_INTERFACE_CONFIG" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_42_SM_ISCLI_68_VLAN_BASIC_CONFIG" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_16_IP_NOOP" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_60_VLAN_INTERFACE_LIFECYCLE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_66_SWITCHING_MODE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_8_MGMT_STATIC_IP" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_9_L2VPN_EVPN_ORDER" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_11_BGP_GRACEFUL_RESTART" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_12_MGMT_PORT_VISIBLE" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_10_UPDATE_SOURCE" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_13_IBGP_MULTIPATH" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_15_BGP_NETWORK_CONFLICT" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_41_BGP_REMOTE_AS_INTERNAL_EXTERNAL" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_82_BGP_VRF_VALIDATION" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_74_HOSTNAME_VALIDATION" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_29_IP_ROUTE_SVI" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_46_PORT_BREAKOUT" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_60_REMOVE_VLAN_INTERFACE" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_12_SHOW_IP_INTERFACE" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_33_SHOW_RUN_INTERFACE" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_54_SHOW_RUNNING_CONFIG" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_73_VRF_INTERFACE_VALIDATION" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_19_GREP_FILTER" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_20_OSPF_LOOPBACK_NO_IP" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_34_SM_ISCLI_32_SM_ISCLI_31_INTERFACE_IP_CONFIG" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_24_SONIC_CLI_C_FLAG" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_23_ROUTE_MAP_SHOW_RUN" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_82_BGP_VRF_UNCONFIG" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_48_SM_ISCLI_49_SM_ISCLI_51_IPV4_ACL_CLI" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_69_VLAN_NEGATIVE_MEMBER" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_76_SHOW_IP_ROUTE_FILTERING" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_21_OSPF_NETWORK_REMOVAL" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_27_BGP_PEERGROUP_ACTIVATE" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_52_LLDP_CLI_VALIDATION" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_53_HOSTNAME_CONFIG_VERIFICATION" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_70_BGP_IPV6_CLI_VALIDATION" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_72_IPV6_INTERFACE_ENABLE_DISABLE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_76_IP_ROUTE_SHOW_COMMANDS" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_77_VRF_CLI_NEGATIVE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_25_INTERFACE_DESC_QUOTES" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_78_LOOPBACK_INTERFACE_CONFIG" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_26_PLATFORM_INTERFACE_CLI" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_28_BGP_SHOW_CONFIG" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_VRF_BASIC" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_P2_78_LACP_FAST_RATE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_VRF_INTERFACE_NEGATIVE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_VRF_LOOPBACK_PORTCHANNEL_NEGATIVE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_VRF_PING" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_VRF_IP_INTERFACE" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_IP_PREFIX_LIST" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_ARP_TABLE_VERIFICATION" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_INTERFACE_CLI_VERIFICATION" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_ROUTE_MAP_DEPENDENCY" "./testbeds/dlink_1node.yaml" \
...
run_batch "SM_ISCLI_P2_42_VLAN_SVI_REMOVAL" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_P2_39_SWITCHPORT_TRUNK_VLAN" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_13_VRF_BINDING" "./testbeds/dlink_2node.yaml" \
...
run_batch "SM_ISCLI_P2_32_BGP_VRF_INSTANCE" "./testbeds/dlink_2node.yaml" \
...
#run_batch "SM_ISCLI_45_WRITE_ERASE_COMMAND" "./testbeds/dlink_1node.yaml" \
